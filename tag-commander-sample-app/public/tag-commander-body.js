 ...
 * Generated: 2019-07-29 11:24:10 Europe/Paris
 * ---
 * Version	: 1.01
 * IDTC 	: 12
 * IDS		: 4056
...
tC.containersLaunched[4056][12] = {v:'1.01', t:[], g:26};
...
tC.extend({
    ...
    hitCounter_4056_12 : function() {
        if(Math.floor(Math.random()*parseInt(tC_4056_12.frequency)) == 0){
            tC.pixelTrack.add("https://manager.tagcommander.com/utils/hit.php?id="+tC_4056_12.id_container+"&site="+tC_4056_12.id_site+"&version="+tC_4056_12.containerVersion+"&frequency="+tC_4056_12.frequency+"&position="+tC.container_position+"&rand="+Math.random());
        }
    }
});
...
window.postMessage('TC.EX.CONTAINER:{"id":12,"ids":4056,"v":"1.01","g":26,"p":'+tC.container_position+',"url":"'+(document.currentScript ? document.currentScript.src : '')+'"}','*');
...
tC.id_site='4056';if(tC.getCookie('tc_mode_test')==1){(function(){var tc_testmodescriptload=document.createElement('script');tc_testmodescriptload.type='text/javascript';tc_testmodescriptload.src='//manager.tagcommander.com/utils/test_mode_include.php?id=12&site=4056&type=load&rand='+Math.random()+'&version=';(document.getElementsByTagName('body')[0]||document.getElementsByTagName('head')[0]||document.getElementsByTagName('script')[0].parentNode).appendChild(tc_testmodescriptload);})();}else{
/*VARIABLES_BLOCK*/
...
tC.onDomReady(function(){tC.container_4056_12.eventlisteners();});